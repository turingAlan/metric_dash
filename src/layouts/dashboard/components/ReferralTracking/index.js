...
function ReferralTracking() {
	...
	const [sensitiveData] = useState(Math.floor(Math.random() * (12000 - 3000 + 1)) + 3000);
	const [hashedData] = useState(sensitiveData - (Math.floor(Math.random() * 3) + 1));
						...
						<VuiBox
							...
							<VuiBox display='flex' flexDirection='column' justifyContent='center' alignItems='center'>
								...
								<VuiTypography
									...
									{
										(((hashedData) / (sensitiveData)) * 10).toFixed(1)
									}
								</VuiTypography>
